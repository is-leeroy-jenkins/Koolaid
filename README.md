...
Koolaid is a WPF-based web crawler written in C-Sharp. Web crawlers, also known as spiders, are most often used by search engines such as Google, Bing DuckDuckGo, 
